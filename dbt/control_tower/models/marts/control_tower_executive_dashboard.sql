...
select
    ...
    wd.country_code,
    wd.country_name,
    coalesce(o.shipment_records, 0) as shipment_records,
    ...
    coalesce(o.in_full_rate, 0) as in_full_rate,
    ...
    coalesce(i.inventory_below_reorder_sku_count, 0) as inventory_below_reorder_sku_count,
